            ...
            <div class="main-content-inner">
                <div class="row mt-5 mb-2">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-2">Detail Lembaga</h4>
                                <div id="accordion1" class="according">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        ?>
                                                            ...
                                                            <div class="form-row align-items-center mb-4">
                                                                <a class="btn btn-primary btn-xs" href="<?php echo site_url('lembaga/edit_lembaga/' . $list->kode_lembaga) ?>" title="Edit">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center"><img src="<?php echo base_url('uploads/' . $list->foto) ?>" </td> <td class="text-center">
                                                                                        <a class="btn btn-primary btn-xs" href="<?php echo site_url('lembaga/edit_pengurus/' . $list->nip) ?>" title="Edit">
                                                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Edit
                                                                                        </a>
                                                                                        <a class="btn btn-danger btn-xs" href="<?php echo site_url('lembaga/hapus_pengurus/' . $list->nip) ?>" title="Edit">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="accordion12" class="collapse" data-parent="#accordion1">
                                            <div class="card-body">
                                                <form action="<?php echo site_url('lembaga/simpan_data'); ?>" method="post" enctype="multipart/form-data">
                                                    <div class="form-row align-items-center">
                                                        <div class="col-sm-3">
                                                            <?php
                                                            foreach ($l as $list) {
                                                            ?>
                                                                <input type="hidden" name="kode_lembaga" id="kode_lembaga" value="<?php echo $list->kode_lembaga; ?>">
                                                            <?php } ?>
